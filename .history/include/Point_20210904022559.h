...
namespace Curves
{
    ...
    public:
        ...
        friend Point<T> operator+(const Point<T> &left, const Point<T> &right);
        friend Point<T> operator*(const Point<T> &left, const Point<T> &right);
        friend Point<T> operator*(const Point<T> &left, const T right);
...
Point<T> operator+(const Point<T> &left, const Point<T> &right){
    return Point<T>(left.point[0] + right.point[0], left.point[1] + right.point[0])
}
friend Point<T> operator*(const Point<T> &left, const Point<T> &right);
friend Point<T> operator*(const Point<T> &left, const T right);